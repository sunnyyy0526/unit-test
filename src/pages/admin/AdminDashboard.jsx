...
<div className="filters-row">
  <div className="filter-group">
    <label htmlFor="ward" className="filter-label">Ward</label>
    <input
      id="ward"
      placeholder="e.g. 5"
      value={filters.ward}
  ...
  <div className="filter-group">
    <label htmlFor="wasteType" className="filter-label">Waste Type</label>
    <select
      id="wasteType"
...
//       slaBreaches: requests.filter((r) =>
//         ["Open", "Assigned", "In Progress", "Rejected"].includes(r.status)
//       ).length,
//     });
//   };
...
//     const normalized = storedRequests.map((r, i) => ({
//       ...r,
//       _id: r._id || `${Date.now()}-${i}`,
//       notes: r.notes || [],
//     }));

//     setItems(normalized);
//     setOperators(storedOperators);
//     if (normalized.length) setSelectedId(normalized[0]._id);
